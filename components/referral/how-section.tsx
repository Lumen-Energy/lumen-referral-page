const steps = [
  {
    ...
    chips: ["Email loop-in", "3-way call", "Whatever's natural"],
    highlight: false,
  },
  {
    num: "02",
    ...
    chips: ["Feasibility", "Bid process", "Developer match", "Contract"],
    highlight: false,
  },
  {
    num: "03",
...
export function HowSection() {
  return (
    <section id="how" className="section-pad-sm" style={{ paddingBottom: 0 }}>
